...
if __name__ == "__main__":
    ...
    D = torch.load("Discriminator_epoch_200.pth")

    # Settings
    epochs = 200
    batch_size = 256
    loss_function = nn.BCELoss()
    g_optimizer = optim.Adam(G.parameters(), lr=0.0006, betas=(0.5, 0.999))
    ...
    for epoch in range(1, epochs+1):
        ...
        if epoch % 100 == 0:
            ...
            torch.save(D, 'Discriminator_epoch_{}.pth'.format(epoch))
            print('Model saved.')
